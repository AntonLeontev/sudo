...
return [
	...
	'spec' => [
		...
		'text' => 'Команда компании SUDO состоит из высококвалифицированных специалистов в области разработки, проектирования и анализа, многие из которых являются научными сотрудниками в ведущих ВУЗах страны и имеют учёные степени как в России, так и за рубежом. Мы регулярно участвуем в научных и инженерных исследованиях и в научных мероприятиях, что позволяет поддерживать высокий уровень профессионализма при выполнении работ.',
		'list' => [
			'1' => 'Штат нашей компании насчитывает около 25 сотрудников ',
